...
class __Mustache_a3f46fc74c3887f61d178bebfefe9018 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<div class="section-navigation mdl-bottom d-flex justify-content-between">
';
...
';
        $buffer .= $indent . '        ';
        $value = $this->resolveValue($context->find('selector'), $context);
