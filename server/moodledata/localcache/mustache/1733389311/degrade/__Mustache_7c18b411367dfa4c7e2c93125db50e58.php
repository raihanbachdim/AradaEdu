...
class __Mustache_7c18b411367dfa4c7e2c93125db50e58 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionBf5385436113ead01bb42b88fc6abbda($context, $indent, $value);
        $value = $context->find('unauthenticateduser');
        if (empty($value)) {
...
';
    ...
    private function sectionBf5385436113ead01bb42b88fc6abbda(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '        <span class="login pl-2 btn btn-primary">
';
